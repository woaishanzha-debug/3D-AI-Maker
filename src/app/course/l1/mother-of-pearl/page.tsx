...
const RadenCanvas = dynamic(() => import('@/components/Raden/Canvas').then((mod) => mod.Canvas), {
    ssr: false,
    loading: () => (
        <div className="w-full h-[600px] bg-slate-900 rounded-[40px] flex items-center justify-center border border-white/5 shadow-2xl">
            <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-blue-400 font-black text-xs uppercase tracking-widest animate-pulse">正在构建幻彩实验室...</p>
            </div>
        </div>
    )
});
            ...
            <div className="fixed top-0 left-0 right-0 h-16 bg-black/40 backdrop-blur-xl border-b border-white/5 z-50 flex items-center justify-between px-8">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 text-[10px] font-black uppercase tracking-tighter">L1-14</span>
                        <h1 className="font-black text-sm italic tracking-widest uppercase">流光溢彩：螺钿工艺设计</h1>
                    </div>
                </div>
                ...
                <AnimatePresence mode="wait">
                    ...
                    {step === 1 && (
                        ...
                        >
                            ...
                            <PresentationViewer slug="mother-of-pearl" dataFile="refined.json" />
                        ...
                        >
                            ...
                            <div className="space-y-4 relative z-10">
                                ...
                                <p className="text-blue-200/60 font-medium max-w-lg mx-auto leading-relaxed">
                                    恭喜！你已完成《流光溢彩：螺钿工艺设计》的数字化溯源学习。相关的 3D 打印实践任务已在创客空间开启。
                                </p>
                            </div>
