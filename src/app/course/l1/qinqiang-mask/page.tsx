...
const QinqiangCanvas = dynamic(() => import('@/components/QinqiangCanvas').then((mod) => mod.QinqiangCanvas), {
    ssr: false,
    loading: () => (
        <div className="w-full h-[600px] bg-slate-900 rounded-[40px] flex items-center justify-center border border-white/5 shadow-2xl">
            <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-blue-400 font-black text-xs uppercase tracking-widest animate-pulse">正在初始化数字脸谱实验室...</p>
            </div>
        </div>
    )
});
