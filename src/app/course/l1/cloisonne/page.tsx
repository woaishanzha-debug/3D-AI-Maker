                        ...
                        {step === 3 && (
                            ...
                            >
                                ...
                                <div className="flex gap-4 relative z-10">
                                    ...
                                    <Link href="/course/l1/embroidery" className="px-10 py-4 bg-blue-600 rounded-2xl font-black text-sm text-white shadow-xl hover:bg-blue-500 transition-all font-sans">
