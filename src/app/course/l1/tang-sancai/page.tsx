            ...
            <div className="fixed top-0 left-0 right-0 h-16 bg-black/40 backdrop-blur-xl border-b border-white/5 z-50 flex items-center justify-between px-8">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 text-[10px] font-black uppercase tracking-tighter">L1-09</span>
                        <h1 className="font-black text-sm italic tracking-widest uppercase">古韵唐风：唐三彩造型</h1>
                    </div>
                </div>
                ...
                <AnimatePresence mode="wait">
                    ...
                    {step === 1 && (
                        ...
                        >
                            ...
                            <PresentationViewer slug="tang-sancai" dataFile="refined.json" />
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 bg-amber-600 rounded-2xl flex items-center justify-center shadow-[0_0_40px_rgba(217,119,6,0.4)]">
                                        <Sparkles className="w-6 h-6 text-white" />
                                    </div>
                                    <div>
                                        <h2 className="text-2xl font-black italic">模块化唐三彩与釉色流淌</h2>
                                        <p className="text-sm text-blue-200/60">组合各个组件，并通过调节强度触发釉色的“流动”窑变效果。</p>
                                    </div>
                                </div>
