            ...
            <div className="fixed top-0 left-0 right-0 h-16 bg-black/40 backdrop-blur-xl border-b border-white/5 z-50 flex items-center justify-between px-8">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 text-[10px] font-black uppercase tracking-tighter">L1-13</span>
                        <h1 className="font-black text-sm italic tracking-widest uppercase">指尖兵符：虎符立体复刻</h1>
                    </div>
                </div>
                ...
                <AnimatePresence mode="wait">
                    ...
                    {step === 1 && (
                        ...
                        >
                            ...
                            <PresentationViewer slug="tiger-tally" dataFile="refined.json" />
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 bg-orange-600 rounded-2xl flex items-center justify-center shadow-[0_0_40px_rgba(234,88,12,0.4)]">
                                        <Trophy className="w-6 h-6 text-white" />
                                    </div>
                                    <div>
                                        <h2 className="text-2xl font-black italic">兵符榫卯错齿设计</h2>
                                        <p className="text-sm text-blue-200/60">通过逆向几何偏移计算，确保左右“子母相扣”严丝合缝。</p>
                                    </div>
                                </div>
                        ...
                        >
                            ...
                            <div className="space-y-4 relative z-10">
                                ...
                                <p className="text-blue-200/60 font-medium max-w-lg mx-auto leading-relaxed">
                                    恭喜！你已完成《指尖兵符：虎符立体复刻》的数字化溯源学习。相关的 3D 打印实践任务已在创客空间开启。
                                </p>
                            </div>
