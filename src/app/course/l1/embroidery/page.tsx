...
const EmbroideryCanvas = dynamic(() => import('@/components/EmbroideryCanvas').then((mod) => mod.EmbroideryCanvas), {
    ssr: false,
    loading: () => (
            ...
            <div className="fixed top-0 left-0 right-0 h-16 bg-black/40 backdrop-blur-xl border-b border-white/5 z-50 flex items-center justify-between px-8">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 text-[10px] font-black uppercase tracking-tighter">L1-03</span>
                        <h1 className="font-black text-sm italic tracking-widest uppercase">传统刺绣：线性的律动</h1>
                    </div>
                </div>
                ...
                <AnimatePresence mode="wait">
                    ...
                    {step === 1 && (
                        ...
                        >
                            ...
                            <PresentationViewer slug="embroidery" dataFile="refined.json" />
                            ...
                            <div className="absolute top-8 right-8 z-30 flex gap-4">
                                <button onClick={() => setStep(2)} className="px-8 py-4 bg-blue-600 text-white rounded-2xl font-black text-sm flex items-center gap-2 hover:bg-blue-500 transition-all shadow-2xl active:scale-95">
                                    进入刺绣实验室 <Wand2 className="w-4 h-4" />
                                </button>
                            </div>
                        </motion.div>
                    )}
                        ...
                        >
                            ...
                            <div className="space-y-4 relative z-10">
                                ...
                                <p className="text-blue-200/60 font-medium max-w-lg mx-auto leading-relaxed">
                                    恭喜！你已完成《传统刺绣：线性的律动》的数字化溯源学习。相关的 3D 打印实践任务已在创客空间开启。
                                </p>
                            </div>
